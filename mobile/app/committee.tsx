  ...
  return (
    <View style={styles.root}>
      ...
      <SafeAreaView style={{ flex: 1 }} edges={['bottom']}>
        ...
        ) : data && (data.bureau.length + data.codir.length + data.coaches.length) === 0 ? (
          <EmptyState
            icon="👥"
            title="Trombinoscope à venir"
            message="Aucun rôle CoDir ni entraîneur n'est actuellement renseigné."
          />
        ) : (
          <ScrollView
